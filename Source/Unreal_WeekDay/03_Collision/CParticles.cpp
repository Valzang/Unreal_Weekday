...
ACParticles::ACParticles()
{
	...
	CHelpers::GetAsset<UParticleSystem>(&Particles[2], "ParticleSystem'/Game/Effects/P_AOE_Ice_CircleAttack.P_AOE_Ice_CircleAttack'");
	CHelpers::GetAsset<UParticleSystem>(&Particles[3], "ParticleSystem'/Game/Effects/P_Explosion2.P_Explosion2'");
	CHelpers::GetAsset<UParticleSystem>(&Particles[4], "ParticleSystem'/Game/Effects/P_HeldCharge_Ice_00.P_HeldCharge_Ice_00'");
