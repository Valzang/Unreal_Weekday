...
DEFINE_LOG_CATEGORY_STATIC(InGameLog, Warning, All)
...
{
	UE_LOG(InGameLog, Warning, L"%d", InValue);
}

void CLog::Log(float InValue)
{
	UE_LOG(InGameLog, Warning, L"%f", InValue);
}

void CLog::Log(const FString& InValue)
{
	UE_LOG(InGameLog, Warning, L"%s", *InValue);
}

void CLog::Log(const FVector& InValue)
{
	UE_LOG(InGameLog, Warning, L"%s", *InValue.ToString());
}
...
void CLog::Log(const UObject* InObject)
{
	...
	UE_LOG(InGameLog, Warning, L"%s", *str);
}
